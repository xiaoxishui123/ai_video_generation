...
> **更新日期**: 2025-12-24
> **变更说明**: 
> - 🆕 新增 **通义万相 2.6** 模型支持（文生视频 + 图生视频）
> - 🆕 支持 5/10/15 秒时长选项（通义万相 2.6）
> - 🆕 支持 480p/720p/1080p 多分辨率（通义万相 2.6）
> - 优化模型选项显示，推荐使用最新的 2.6 版本
...
| 平台 | 模型ID | 功能 | 说明 |
|------|--------|------|------|
| 阿里云百炼 | `wan2.6-t2v` | 文生视频 | 通义万相 2.6 T2V (最新，推荐) |
| 阿里云百炼 | `wan2.6-i2v` | 图生视频 | 通义万相 2.6 I2V (最新，推荐) |
